...
function Difficulty({ setSettings, setMineCount, setCustom, custom }) {
    ...
    return (
        <div className="flex flex-col gap-2.5 w-xs p-3 border rounded-lg bg-green-600">
            ...
            <div className="flex justify-evenly">
                <button onClick={ () => setCustom( custom ? false : true ) } className="w-3/10 border rounded-sm bg-green-500">
                    Custom
                </button>
            </div>
        </div>
